             ...
             Padding(
               ...
               child: Row(
                ...
                children: [
                  Row(
                    children: [
                      const Icon(Icons.event_seat_rounded, color: Colors.grey,),
                      Padding(
                        padding: const EdgeInsets.only(left: 6.0),
                        child: Text("Available", style: TextStyle(color: Colors.grey.shade500)),
                      )
                    ],
                  ),
                  Row(
                    children: [
                      Icon(Icons.event_seat_rounded, color: Colors.orange.shade900),
                      Padding(
                        padding: const EdgeInsets.only(left: 6.0),
                        child: Text("Selected", style: TextStyle(color: Colors.grey.shade500))
                      )
                    ],
                  ),
                  Row(
                    children: [
                      const Icon(Icons.event_seat_rounded, color: Colors.black54,),
                      Padding(
                        padding: const EdgeInsets.only(left: 6.0),
                        child:  Text("Reserved", style: TextStyle(color: Colors.grey.shade500)),
                      )
                    ],
                  ),
                ],
